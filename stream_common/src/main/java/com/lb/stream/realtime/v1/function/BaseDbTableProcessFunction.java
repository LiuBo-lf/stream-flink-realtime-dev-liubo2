...
import com.lb.stream.realtime.v1.bean.TableProcessDwd;
import com.lb.stream.realtime.v1.utils.JdbcUtil;
...
/**
 * @ Package com.lb.stream.realtime.v1.function.BaseDbTableProcessFunction
 * @ Author  liu.bo
 * @ Date  2025/5/9 10:24
 * @ description:
 * @ version 1.0
